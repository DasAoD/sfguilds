...
function ensureSchema(PDO $pdo): void
{
	...
	$pdo->exec("CREATE INDEX IF NOT EXISTS idx_members_guild_rank ON members(guild_id, rank)");
	$pdo->exec("CREATE INDEX IF NOT EXISTS idx_members_guild_name ON members(guild_id, name)");
}
